...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto">
  ...
  │
  ├───data
  │       voc.yaml              <span class="pl-c"><span class="pl-c">#</span>Config data custom_dataset.yaml</span>
  │
  └───utils
      │   datasets.py               <span class="pl-c"><span class="pl-c">#</span>Processing datasets</span>
      │   metric.py                <span class="pl-c"><span class="pl-c">#</span> Compute metrics</span>
...
<li><a href="https://arxiv.org/pdf/1506.02640v5.pdf">Yolov1</a></li>
</ul>
